...
// Subcategorías de Capital Humano
const subcategorias = [
  "Aspectos Generales",
...
const progresoGuardado = JSON.parse(localStorage.getItem("respuestasCapitalHumano")) || {};
...
preguntasCapitalHumano.forEach((pregunta, index) => {
  ...
  select.addEventListener("change", () => {
    ...
    localStorage.setItem("respuestasCapitalHumano", JSON.stringify(progresoGuardado));
  });
...
formulario.addEventListener("submit", function (e) {
  ...
  sessionStorage.setItem("areaSeleccionada", "Capital Humano");
